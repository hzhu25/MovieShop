...
namespace Infrastructure.Services
{
    public class MovieService : IMovieService
    {
        ...
        public async Task<PaginatedResultSet<MovieCardModel>> GetMoviesByPagination(int genreId, int pageSize = 30, int page = 1)
        {
            ...
            return new PaginatedResultSet<MovieCardModel>(movieCards, page, pageSize, movies.TotalRowCount);
        }
